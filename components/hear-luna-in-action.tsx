...
export function HearLUNAInAction() {
      ...
      <div className="container px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-xl text-slate-400 max-w-3xl mx-auto">
            Experience the future of AI voice technology. Listen to real interactions showcasing our natural, human-like
            conversations with L.U.N.A.
          </p>
        </div>
